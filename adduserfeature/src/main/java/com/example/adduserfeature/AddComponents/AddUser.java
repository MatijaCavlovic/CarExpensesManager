        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nameString==null || nameString.isEmpty()){
                    Toast.makeText(getApplicationContext(), "Ime korisnika nije uneseno",Toast.LENGTH_LONG).show();
                    return;
                }

                if (surnameString==null || surnameString.isEmpty()){
                    Toast.makeText(getApplicationContext(), "Prezime korisnika nije uneseno",Toast.LENGTH_LONG).show();
                    return;
                }
